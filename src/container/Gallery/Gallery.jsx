  ...
  return (
    <div className="app__gallery flex__center">
      <div className="app__gallery-content">
        ...
        <p className="p__opensans" style={{ color: '#AAA', marginTop: '2rem' }}>Here's a glimpse of the excellent culinary experience you get at Mufasa's.</p>
        ...
        <div className="app__gallery-images_container" ref={scrollRef}>
          {allImages.map((image, index) => (
            <div className="app__gallery-images_card flex__center" key={`gallery-image-${index + 1}`}>
              <img src={image} alt="instagram feed" />
